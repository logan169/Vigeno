...
@app.route('/api/v0/getDNA&AA/<seq>/<ref_strand>/<frame>/', methods=['POST','GET'])
def getSequences(seq,ref_strand,frame):
    seq=str(seq)
    ref_strand=str(ref_strand)
    temp= K.JSONResponse(DNA_and_6FramesTraduction(seq,ref_strand,frame),False,'')
